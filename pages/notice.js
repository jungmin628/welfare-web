...
export default function FAQPage() {
  const faqs = [
    {
      q: "대여를 변경하고싶은데 어떻게 해야하나요?",
      a: "변경을 원할 시, 즉시 부위원장 이정민(010-9426-1027)로 연락부탁드리며, 원하시는 물품을 다른 단체가 이미 대여를 완료했을 시, 대여가 제한됩니다. 또한, 대여 변경을 원하여 물품신청서를 더 작성하셔도, 하나의 행사당 하나의 물품신청서를 받고 있기 때문에 같은 행사일 경우 최종으로 부위원장과 연락이 되어 승인된 물품신청서'만' 반영합니다." 
    },
    {
      q: "대여 신청은 언제 할 수 있나요?",
