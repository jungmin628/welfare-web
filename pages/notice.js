  ...
  const faqs = [
    {
      ...
      a: "먼저, 제출이 안되는 경우는 집회신고서 첨부파일이 700KB를 넘기 때문입니다. 첨부파일을 pdf파일을 압축해서 제출해주세요. https://www.ilovepdf.com/ko 해당 웹사이트를 들어가면, pdf 변환 및 압축이 가능합니다. 계속해서 문제가 발생할 시, 부위원장(010-4002-0516)에게 본인이 작성한 물품신청서 캡처본과 집회신고서를 보내주시기 바랍니다. " 
    },
    {
      q: "대여물품을 변경하고싶은데 어떻게 해야하나요?",
      a: "변경을 원할 시, 즉시 부위원장 전현태(010-4002-0516)로 연락부탁드리며, 원하시는 물품을 다른 단체가 이미 대여를 완료했을 시, 대여가 제한됩니다. 또한, 대여 변경을 원하여 물품신청서를 더 작성하셔도, 하나의 행사당 하나의 물품신청서를 받고 있기 때문에 같은 행사일 경우 최종으로 부위원장과 연락이 되어 승인된 물품신청서'만' 반영합니다. 대여 일정 변경 및 물품 변경의 빈도수가 많은 단체는 다음 물품 대여에 패널티가 적용될 수 있습니다. " 
    },
    {
    ...
    {
      q: "대여 신청은 언제 할 수 있나요?",
      a: "학생복지위원회 홈페이지를 통한 대여 신청은 행사일 기준 1주일 전부터 신청하는 것을 권장드립니다. 대여 승인의 경우 학생복지위원회가 대여 가능 여부를 마지막으로 직접 확인한 후, 승인 여부를 문자로 안내드립니다."
    },
    {
    ...
    {
      q: "문의는 어디로 하면 되나요?",
      a: "학생복지위원장(010-9383-8422), 학생복지부위원장(010-4002-0516)에게 연락 바랍니다."
    }
  ];
    ...
    <>
      ...
      <div className="notice-container">
        ...
        <div className="contact-box">
          <p>
            <strong>학생복지위원장</strong> 안현성 ☎ 010-9383-8422
          </p>
          <p>
            <strong>학생복지부위원장</strong> 전현태 ☎ 010-4002-0516
          </p>
        </div>
